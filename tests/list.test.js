...
describe('totalLikes', () => {
  ...
  test('returns the likes of the only blog in a list', () => {
    const result = listHelper.totalLikes(singleBlogList)

    assert.strictEqual(result, 5)
  })

  test('returns the total number of likes from multiple blogs', () => {
...
describe('mostBlogs', () => {
  test('returns the author with the most published blogs', () => {
